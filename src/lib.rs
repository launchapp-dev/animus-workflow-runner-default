...
pub use phase_git::{
    commit_implementation_changes, current_branch, ensure_git_identity, git_has_pending_changes, is_git_repo,
    publish_head_durably, redact_git_diagnostic, verify_publication_proof, PublicationProof,
};
