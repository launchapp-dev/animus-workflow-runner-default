...
pub fn read_persisted_decision(
    ...
    Ok(PhaseDecision {
        ...
        verdict,
        // TODO(codex-p2): crash-recovery replay should reconstruct a v0.7 custom
        // verdict key as `Unknown + verdict_key`; `None` preserves the v0.4.20
        // built-in-verdict replay (no regression) pending custom-key adoption.
        verdict_key: None,
